 ...
 * @returns {any}
 */
export const findResource = (id, token) => findResourceWithOauthClientId(id, token.oauthClientId);
 ...
 * @returns {any}
 */
export const findResourceWithOauthClientId = (id, oauthClientId) => models.oauthClientResources.findOne({
    ...
    try {
      ...
      if (!isEmpty(foundResource)) {
        return models.oauthClientResources
          ...
          .then(() => findResourceWithOauthClientId(
            resource.id,
            resource.oauthClientId,
          ));
      }
 ...
 * @returns {any}
 */
export const createOauthResources = ({ oauthClientId, resources }, t) => models.oauthClientResources.bulkCreate(
