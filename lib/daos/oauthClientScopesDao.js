...
export const findScopeFromOauthClientId = (oauthClientId) => models.oauthClientScopes.findOne({
  attributes: ALL_ATTRIBUTES,
  where: {
    oauthClientId,
  },
...
export const createOauthScope = ({ oauthClientId, scope }, t) => models.oauthClientScopes.create(
  { scope, oauthClientId },
  { transaction: t },
);
