...
export const findOneOauthClient = (grantType, clientId, clientSecret) => models.oauthClients.findOne({
 ...
 * @param {Number} id
 */
export const getMetaDataByOAuthClientId = (id) => models.oauthClients
  .findOne({
    where: { id },
...
export const findAllOauthClients = (page, limit) => models.oauthClients.findAll({
